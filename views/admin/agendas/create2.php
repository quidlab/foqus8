                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                <label>Sort_ID</label>
                                <input type="number" min="0" name="Sort_ID" class="form-control" id="Sort_ID" placeholder="Sort_ID">
                            </div>
                            <div class="form-group col-md-6">
                ...
                <div class="card card-primary mx-4" id="directorsCard">
                    ...
                    <div class="card-body">
                        <div id="NumberOfDirectorsToEleectContainer" class="form-group col-md-6">
                            ...
                            <input type="number" class="form-control" min="1" name="NumberOfDirectorsToEleect" id="NumberOfDirectorsToEleect">
                        </div>
                    ...
                    <button type="button" id="removeBtn" class="btn btn-danger mb-2 mx-4 d-none" onclick="removeOneMore()">Remove one more -</button>
                    <button type="button" id="addBtn" class="btn btn-success mx-4  d-none" onclick="addOneMore()">Add one more +</button>
                    <div class="card-footer">
                        <button type="submit" id="submitBtn" class="btn btn-primary">Submit</button>
...
<script>
    ...
    $('#NumberOfDirectorsToEleect').on('keypress', function(e) {
        ...
        firstDirectorsCount =  Number(e.target.value);
        let oldValue = directorsCount;
        directorsCount = Number(e.target.value);
        if (directorsCount <= 0) {
            toastr.error("Min Value Is 1");
            return
        }
        directorsDrawer(oldValue, directorsCount);
        $('#NumberOfDirectorsToEleect').attr("disabled", true);
    ...
    function directorsDrawer(from, to) {
        ...
        if (firstDirectorsCount < $('#directorsCardBody table tbody tr').length) {
    ...
    function removeOneMore() {
        $('#directorsCardBody table tbody tr:last-of-type()').remove();
        if (firstDirectorsCount >= $('#directorsCardBody table tbody tr').length) {
...
<script>
    <?
    foreach (errors() as $error) {
        echo 'toastr.error(' . $error . ')'; // TODO add script and use toastr
    }
    ?>
</script>