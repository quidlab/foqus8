...
<head>
  ...
  <link rel="stylesheet" href="../library/css/file.css">
      <style>
          #pageloader{
...
<body id="page-top">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
              ...
              <div class="card-body">
                ...
                <ul id="" class="back">
                  <li id="Account_ID" class="li-class">TSD registration ID</li>
                  <li id="e_mail" class="li-class">Email</li>
                  <li id="Phone" class="li-class">Mobile Phone</li>
                  <li id="proxy_name" class="li-class">Proxy Name</li>
                  <li id="proxy_type" class="li-class">Proxy Type</li>
                </ul>
  ...
  <script src="../library/js/xlsx.full.min.js"></script>
...
function sortFields() {
var requiredFields =['Account_ID','e_mail','Phone','proxy_name','proxy_type'];
var presentFields = [];
