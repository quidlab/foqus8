...
<?php include "inc/company_name_header.php"; ?> 
    ...
    <section class="content">
      <div class="container-fluid">
        <!-- Info boxes -->
       <div id="Upload-presenters">

                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Upload Presenters</h1>
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <form id="presentersTable" method="POST" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left" action="upload-presenters-action.php">
                                <input type="hidden" name="action" value="upload_presenters">
