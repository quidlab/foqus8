...
if(isset($_POST["action"]) && $_POST["action"] == "upload_presenters"){
    //echo "local<br>";    
  ...
  return substr(str_shuffle($data), 0, $chars);
                ...
                for ($row = 2 ; $row <= $total_rows; $row++) {
                  ...
                  // $pass= generateStrongPassword(9,false,'l'); // modified by kamal
                    ...
                    $sql = "insert into presenter(pid,title,fname,lname,email,mobile,pwd,role) values('".$columnData[0][0]."', N'$title', N'$fname', N'$lname', '".$columnData[0][4]."', '".$columnData[0][5]."', '".$pass."', '".$columnData[0][6]."')";
                ...
                if($success > 0) {
                    ...
                    echo "<script type=\"text/javascript\"> window.location.href='Presenters-list.php';</script>";
                }else {
