...
class Router
{
    ...
    public function get(string $path, callable $handler): object
    {
        $this->addRoute($path, Method::GET, $handler);
        return $this;
    }

    public function post(string $path, callable $handler): object
    {
        $this->addRoute($path, Method::POST, $handler);
        return $this;
    }

    protected function addRoute(string $path, Method $method, callable $handler): void
    {
