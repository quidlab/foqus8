...
if (getenv('SQLCONNSTR_conn')) {
    ...
    $connString = 'Server=tcp:foqus3.database.windows.net,1433;Initial Catalog=foqus3;Persist Security Info=False;User ID=foqus3;Password=ZPen53*D$be>>YR;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30';
}
