...
(window, (function () {
        ...
        ([function (e, t, n) {
                    ...
                    t.default = function (e) {
                        ...
                        d = function () {
                            r.classList.remove("sessionTimeout--hidden"),
                            clearTimeout(t)
                        },
                        f = function () {
                        ...
                        for (var n = 0; n < e.length; n++) {
                            ...
                            if (r) {
                                ...
                                for (; s < o.parts.length; s++)
                                    r.parts.push(g(o.parts[s], t))
                            } else {
                                var a = [];
                                for (s = 0; s < o.parts.length; s++)
                                    a.push(g(o.parts[s], t));
                                i[o.id] = {
                                    id: o.id,
                                    refs: 1,
                                    parts: a
                    ...
                    function v(e, t) {
                        ...
                        var o = d[d.length - 1];
                        if ("top" === e.insertAt)
                            o ? o.nextSibling ? n.insertBefore(t, o.nextSibling) : n.appendChild(t) : n.insertBefore(t, n.firstChild), d.push(t);
